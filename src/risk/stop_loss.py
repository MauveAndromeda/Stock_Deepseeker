...
class StopLossConfig:
    ...
    trailing_distance: float | None = None  # For trailing stops
    volatility_multiplier: float | None = None  # For vol-based stops
    time_horizon_days: int | None = None  # For time-based stops
