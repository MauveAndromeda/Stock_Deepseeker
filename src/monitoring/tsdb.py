...
class TimeSeriesQuery:
    ...
    aggregation: str | None = None  # avg, sum, min, max
    interval: str | None = None  # 1m, 5m, 1h
...
class InMemoryTSDB:
    ...
    def write(self, metric: str, value: float, tags: dict[str, str] | None = None) -> None:
        """Write a data point."""
    ...
    def get_latest(self, metric: str, tags: dict[str, str] | None = None) -> TimeSeriesPoint | None:
...
class PrometheusClient:
    ...
    def register_histogram(self, name: str, description: str, buckets: list[float] | None = None) -> Any:
...
_default_tsdb: TimeSeriesDB | None = None
